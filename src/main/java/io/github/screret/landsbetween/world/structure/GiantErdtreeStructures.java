package io.github.screret.landsbetween.world.structure;
...
public class GiantErdtreeStructures extends StructureFeature<JigsawConfiguration> {

    public GiantErdtreeStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, GiantErdtreeStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return true; //!context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.OCEAN_MONUMENTS, context.seed(), chunkpos.x, chunkpos.z, 10);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!GiantErdtreeStructures.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            LandsBetween.LOGGER.log(Level.DEBUG, "Giant Erdtree at {}", blockpos);
        }
